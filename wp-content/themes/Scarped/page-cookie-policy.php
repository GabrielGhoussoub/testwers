    ...
    <section class="pageWrapper" data-scroll-container>
        <div class="commonPage commonPage--page" data-scroll data-scroll-section>
            <div class="commonPage__wrap">
                <h1 class="commonPage__title title">Cookie Policy</h1>
                <div class="commonPage__text text">
                    <p><a href="https://www.iubenda.com/privacy-policy/30879786/cookie-policy" class="iubenda-white no-brand iubenda-noiframe iubenda-embed iubenda-noiframe iub-body-embed" title="Cookie Policy">Cookie Policy</a>
