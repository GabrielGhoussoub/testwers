    ...
    <section class="pageWrapper" data-scroll-container>
        <article class="newsList" data-scroll-section>
            ...
            <div class="homeNews__wrap"><a href="<?php echo home_url( '/news-press' ) ?>" title="" class="homeNews__block">
                    ...
                    <div class="homeNews__textWrap">
                        <h4 class="homeNews__mainTit title neue-haas bold s">Amarone della Valpolicella Valpantena</h4>
                        <div class="homeNews__mainText text schnyder light s">
                            <p>Mundus Vini<br /> Meininger 2020</p>
                        </div>
                    </div>
                    ...
                    <div class="homeNews__textWrap">
                        <h4 class="homeNews__mainTit title neue-haas bold s">Soave Vintage Edition 2018</h4>
                        <div class="homeNews__mainText text schnyder light s">
                            <p>Soave Trophy 2020</p>
                        </div>
                    </div>
                    ...
                    <div class="homeNews__textWrap">
                        <h4 class="homeNews__mainTit title neue-haas bold s">Ognisanti Valpolicella Classico Superiore 2017</h4>
                        <div class="homeNews__mainText text schnyder light s">
                            <p>Score 95<br /> by James Suckling</p>
                        </div>
                    </div>
                    ...
                    <div class="homeNews__textWrap">
                        <h4 class="homeNews__mainTit title neue-haas bold s">Catullo Valpolicella Ripasso</h4>
                        <div class="homeNews__mainText text schnyder light s">
                            <p>Highly Recommended<br /> by Decanter</p>
                        </div>
                    </div>
                    ...
                    <div class="homeNews__textWrap">
                        <h4 class="homeNews__mainTit title neue-haas bold s">Anteprima Amarone 2016</h4>
                        <div class="homeNews__mainText text schnyder light s">
                    ...
                    <div class="homeNews__textWrap">
                        <h4 class="homeNews__mainTit title neue-haas bold s">Amarone Classico 2011</h4>
                        <div class="homeNews__mainText text schnyder light s">
                            <p>Score 97<br /> by James Suckling</p>
                        </div>
                    </div>
                </a></div><a href="#" id="to-top" class="bertVal__btn button button--blackWhite button--top"><span class="button__round"></span><strong class="button__label">Back to top</strong></a>
        </article>
            ...
            <div class="footer__menu neue-haas bold smallest text">
                <nav id="footer_nav" class="menu-side_nav-container">
                    <ul id="menu-side_nav-1" class="nav navbar-nav">
                        ...
                        <li class="menu-item menu-item-type-taxonomy menu-item-object-category current-menu-item menu-item-29 menu-category-2"><a href="index.html" aria-current="page">News &amp; Press</a></li>
