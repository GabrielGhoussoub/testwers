...
<div id="main_cont">
    <section class="pageWrapper" data-scroll-container="">
        <article class="pageIntro" data-scroll="" data-scroll-section="" data-scroll-repeat="true">
            <div class="pageIntro__top space-between"><a class="pageIntro__btn button button--inverse button--small button--blackWhite" href="../about-us/index.html"><span class="button__round"></span><strong class="button__label">About us</strong></a><a class="pageIntro__btn button button--small button--blackWhite" href="../wines/index.html"><strong class="button__label">Wines</strong><span class="button__round"></span></a></div>
            ...
            <div class="pageIntro__featWrap"><img data-scroll="" data-scroll-speed="-2" class="pageIntro__feat" src="../wp-content/uploads/2021/03/style-scaled.jpg" alt="Style"></div>
        </article>
            ...
            <div class="pageGen__wrap">
                <div class="textCol__col">
                    <div class="textCol__image">
                        <div class="textCol__imgWrap" data-scroll="" data-scroll-speed="-2.5"><img src="../wp-content/uploads/2021/03/style-gallery-01-900x1127.jpg"></div>
                    </div>
                ...
                <div class="textCol__col">
                    <div class="textCol__image">
                        <div class="textCol__imgWrap" data-scroll="" data-scroll-speed="2.5"><img src="../wp-content/uploads/2021/03/style-gallery-02-900x1127.jpg"></div>
                    </div>
                    <div class="textCol__text text light ivar" data-scroll="" data-scroll-repeat="" data-scroll-offset="50%">
        ...
        <article class="pageIntro__featWrap" data-scroll="" data-scroll-section=""><img data-scroll="" data-scroll-speed="-4" class="bertConc__bottom" src="../wp-content/uploads/2021/05/style-bottom-1-1200x712.jpg" alt=""></article>
                ...
                <div class="pageGen__wrap bertVal__st" data-scroll="" data-scroll-sticky="" data-scroll-target="#wrapper">
                    <div class="bertVal__block">
                        ...
                        <div class="bertVal__imgWrap">
                            <div class="bertVal__imgWrapInner"><img class="bertVal__img" src="../wp-content/uploads/2021/05/amarone-scaled.jpg"></div>
                        </div>
                    </div>
                    <div class="bertVal__block">
                        <div class="bertVal__trigger">
                        ...
                        <div class="bertVal__imgWrap">
                            <div class="bertVal__imgWrapInner"><img class="bertVal__img" src="../wp-content/uploads/2021/04/style3-scaled.jpg"></div>
                        </div>
                    </div>
                    <div class="bertVal__block">
                        <div class="bertVal__trigger">
                        ...
                        <div class="bertVal__imgWrap">
                            <div class="bertVal__imgWrapInner"><img class="bertVal__img" src="../wp-content/uploads/2021/05/Bitmap-Copy-8-scaled.jpg"></div>
                        </div>
                    </div>
                    <div class="bertVal__block">
                        <div class="bertVal__trigger">
                        ...
                        <div class="bertVal__imgWrap">
                            <div class="bertVal__imgWrapInner"><img class="bertVal__img" src="../wp-content/uploads/2021/05/cru-scaled.jpg"></div>
                        </div>
                    </div>
