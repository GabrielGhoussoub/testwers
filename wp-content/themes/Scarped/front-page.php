<?php get_header(); ?>
    ...
    <div id="main_cont">
        ...
        <article class="homeSec homeSec--comp" data-scroll data-scroll-section data-header="beige" data-scroll-repeat="true">
          <div class="homeSec__inner comp">
            <div class="homeSec__col comp__col--text">
              ...
              </div><a class="comp__btn button" data-scroll href="/about-us" title="Discover our company"><strong class="button__label">Discover our company</strong>
            ...
            <div class="trad__inner" data-scroll data-scroll-sticky data-scroll-target="#tradition" data-header="brown">
              ...
              <div class="trad__textMask">
                <div class="trad__innerText">
                  ...
                  <a class="trad__btn button button--whitelabel" data-scroll data-header="brown" href="/style" title="Our style revealed"><strong class="button__label">Our style revealed</strong>
          ...
          <div class="homeSec__inner wines" data-scroll>
            ...
            <div class="wineBg lazy" id="home-wine-bg"><video class="vis__vid" id="home-video-2" data-src="/loop_vini_bertani_new-2.mp4" muted loop playsinline autoplay poster="wp-content/uploads/2021/02/vini-bg-scaled.jpg">
              ...
              <div class="wineBg__inner" data-scroll data-scroll-offset="40%">
                ...
                </div><a class="wineBg__btn button button--whitelabel" data-scroll href="/wines" title="Discover all wines"><strong class="button__label">Discover all wines</strong>
        ...
        <article class="homeSec text-center" id="home-terr" data-scroll-offset="40%" data-scroll data-header="brown" data-scroll-section data-scroll-repeat="true">
          ...
          <div class="homeSec__inner">
            ...
            <div class="buss" data-scroll data-header="brown">
              ...
              </div><a class="terr__btn button button--redWhite" href="/territory" title="Explore our land"><strong class="button__label">Explore our land</strong><span class="button__round magic-hover magic-hover__square"></span></a>
            </div>
          </div>
        </article>
        <article class="homeSec" data-scroll data-scroll-section data-header="beige">
          <div class="homeSec__inner homeNews">
            ...
            <div class="homeNews__wrap">
              ...
              </div><a class="homeNews__btn button button--red" href="category/news-press" title="Read all news"><strong class="button__label">Read all news</strong><span class="button__round magic-hover magic-hover__square"></span></a>
            </div>
          </div>
        </article>
      ...
      <noscript><iframe src="http://cdn.iubenda.com/cookie_solution/empty.html" height="0" width="0" style="display:none;visibility:hidden" suppressedsrc="https://www.googletagmanager.com/ns.html?id=GTM-NT8TBK6" class=" _iub_cs_activate" data-iub-purposes="2"></iframe></noscript>
